        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-3 p-3 rounded-lg bg-[#1a1a2e]/50 border border-[#2a2a3e]"
                >
          ...
          <div className="grid grid-cols-2 gap-4">
            {services.map((service, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#d4a853] to-[#f59e0b] flex items-center justify-center mb-4">
