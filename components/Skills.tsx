          ...
          {categories.map((category, catIndex) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-lg bg-[#bb0000]/20 flex items-center justify-center">
                ...
                {skills[category.key as keyof typeof skills].map((skill, index) => (
                  <div key={skill.name}>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-[#bb0000] text-sm font-medium">{skill.level}%</span>
                    </div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["React", "Next.js", "TypeScript", "Python", "Node.js", "AWS", "Docker", "Git", "Figma", "SQL"].map(
              (tech) => (
                <div
                  key={tech}
                  className="px-4 py-2 rounded-lg bg-[#282828] border border-gray-800 text-gray-400 text-sm hover:border-[#bb0000]/50 hover:text-white transition-all duration-300"
                >
                  {tech}
                </div>
              )
